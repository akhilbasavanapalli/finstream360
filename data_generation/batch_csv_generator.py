...
def generate_transactions(customers_df: pd.DataFrame, n: int = 500_000) -> pd.DataFrame:
    ...
    for _ in range(n):
        ...
        amount_ranges = {
            "GROCERY_STORE": (10, 350), "GAS_STATION": (30, 120),
            "RESTAURANT": (15, 250),    "ONLINE_RETAIL": (5, 2500),
            "TRAVEL": (200, 8000),       "ENTERTAINMENT": (20, 500),
            "HEALTHCARE": (50, 5000),    "UTILITIES": (50, 400),
        ...
        is_fraud = (
            ...
            or (amount > cust["credit_limit_usd"] * 0.85 and random.random() < 0.30)
        )
...
def main():
    ...
    log.info("Transaction fraud rate: %.2f%%",
             100 * transactions_df["is_fraud"].sum() / len(transactions_df))
